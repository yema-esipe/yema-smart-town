...
public class AqsConsultPanel extends JPanel {
	...
	public void getAvgValues() {
		...
		if (dataList.size() > 0) {
			...
			JLabel finesParticules = new JLabel("<html><center>Particules fines<br> <br>" + dataAVG.getFinesParticules() + " µg/m^3</html>"); finesParticules.setFont(littleFont);
			...
			JLabel sulfurDioxide = new JLabel("<html><Center>Dioxyde de soufre<br> <br>" + dataAVG.getSulfurDioxide() + " µg/m^3</html>"); sulfurDioxide.setFont(littleFont);
			...
			JLabel ozone = new JLabel("<html> <center> Ozone <br> <br>" + dataAVG.getOzone() + " µg/m^3</html>"); ozone.setFont(littleFont);
